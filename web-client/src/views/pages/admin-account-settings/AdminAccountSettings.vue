<template>
  <v-card id="account-setting-card">
    ...
    <v-tabs-items v-model="tab">
      <v-tab-item>
        <account-settings-account :account='userInfoData' :hello='test'></account-settings-account>
      </v-tab-item>

      <v-tab-item>
        <account-settings-security :accountPassword="userInfoData.password"></account-settings-security>
      </v-tab-item>
...
const { adminConfig } = require('@/main')
